...
@test "($PLUGIN_COMMAND_PREFIX:promote) changes CLICKHOUSE_URL" {
  ...
  dokku config:set my-app "CLICKHOUSE_URL=clickhouse://u:p@host:9000/db" "DOKKU_CLICKHOUSE_BLUE_URL=clickhouse://l:$password@dokku-clickhouse-l:9000/l"
...
@test "($PLUGIN_COMMAND_PREFIX:promote) uses CLICKHOUSE_DATABASE_SCHEME variable" {
  password="$(sudo cat "$PLUGIN_DATA_ROOT/l/PASSWORD")"
  dokku config:set my-app "CLICKHOUSE_DATABASE_SCHEME=clickhouse2" "CLICKHOUSE_URL=clickhouse://u:p@host:9000/db" "DOKKU_CLICKHOUSE_BLUE_URL=clickhouse2://l:$password@dokku-clickhouse-l:9000/l"
  dokku "$PLUGIN_COMMAND_PREFIX:promote" l my-app
  url=$(dokku config:get my-app CLICKHOUSE_URL)
