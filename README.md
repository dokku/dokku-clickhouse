...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 24.3.2.23](https://hub.docker.com/r/clickhouse/clickhouse-server/).
