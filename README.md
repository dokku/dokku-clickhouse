...
Official clickhouse plugin for dokku. Currently defaults to installing [yandex/clickhouse-server 21.8.4.51](https://hub.docker.com/r/yandex/clickhouse-server/).
