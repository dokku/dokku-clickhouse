...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 26.2.4.23](https://hub.docker.com/r/clickhouse/clickhouse-server/).
