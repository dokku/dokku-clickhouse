...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.10.2.65](https://hub.docker.com/r/clickhouse/clickhouse-server/).
