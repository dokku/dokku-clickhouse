...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 23.8.2.7](https://hub.docker.com/r/clickhouse/clickhouse-server/).
