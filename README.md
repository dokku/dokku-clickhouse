...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.2.1.3085](https://hub.docker.com/r/clickhouse/clickhouse-server/).
