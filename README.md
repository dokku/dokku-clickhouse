...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 23.9.1.1854](https://hub.docker.com/r/clickhouse/clickhouse-server/).
...
You can also specify the image and image version to use for the service. It _must_ be compatible with the clickhouse/clickhouse-server image.
