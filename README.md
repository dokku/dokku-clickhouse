...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 23.11.1.2711](https://hub.docker.com/r/clickhouse/clickhouse-server/).
