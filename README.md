...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 23.12.2.59](https://hub.docker.com/r/clickhouse/clickhouse-server/).
