...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.9.3.48](https://hub.docker.com/r/clickhouse/clickhouse-server/).
