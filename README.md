...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.12.4.35](https://hub.docker.com/r/clickhouse/clickhouse-server/).
