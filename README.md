...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.11.1.558](https://hub.docker.com/r/clickhouse/clickhouse-server/).
