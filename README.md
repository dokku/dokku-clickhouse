...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.11.2.24](https://hub.docker.com/r/clickhouse/clickhouse-server/).
