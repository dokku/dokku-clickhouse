...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 24.2.1.2248](https://hub.docker.com/r/clickhouse/clickhouse-server/).
