...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 24.12.2.29](https://hub.docker.com/r/clickhouse/clickhouse-server/).
