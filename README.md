...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 24.12.1.1614](https://hub.docker.com/r/clickhouse/clickhouse-server/).
