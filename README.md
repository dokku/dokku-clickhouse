...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.1.2.3](https://hub.docker.com/r/clickhouse/clickhouse-server/).
