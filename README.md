...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 26.4.1.1141](https://hub.docker.com/r/clickhouse/clickhouse-server/).
