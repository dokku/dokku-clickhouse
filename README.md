...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 26.2.5.45](https://hub.docker.com/r/clickhouse/clickhouse-server/).
