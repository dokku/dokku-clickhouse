...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 26.3.1.896](https://hub.docker.com/r/clickhouse/clickhouse-server/).
