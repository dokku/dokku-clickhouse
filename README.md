...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.4.2.31](https://hub.docker.com/r/clickhouse/clickhouse-server/).
