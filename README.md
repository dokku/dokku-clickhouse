...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 24.8.4.13](https://hub.docker.com/r/clickhouse/clickhouse-server/).
