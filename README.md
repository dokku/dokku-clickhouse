...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.8.1.5101](https://hub.docker.com/r/clickhouse/clickhouse-server/).
