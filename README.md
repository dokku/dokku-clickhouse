...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.8.3.66](https://hub.docker.com/r/clickhouse/clickhouse-server/).
