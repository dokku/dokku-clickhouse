...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.7.2.54](https://hub.docker.com/r/clickhouse/clickhouse-server/).
