...
Official clickhouse plugin for dokku. Currently defaults to installing [yandex/clickhouse-server 21.11.4.14](https://hub.docker.com/r/yandex/clickhouse-server/).
