...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 25.5.1.2782](https://hub.docker.com/r/clickhouse/clickhouse-server/).
