...
Official clickhouse plugin for dokku. Currently defaults to installing [clickhouse/clickhouse-server 24.10.1.2812](https://hub.docker.com/r/clickhouse/clickhouse-server/).
